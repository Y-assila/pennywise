...
$("#mobileMenuBtn").onclick = () => { const sidebar = $(".sidebar"); const button = $("#mobileMenuBtn"); const open = sidebar.classList.toggle("mobile-menu-open"); button.setAttribute("aria-expanded", String(open)); };
